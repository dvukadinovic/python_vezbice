...
print('Integral je: ', simps(b, a))
# prvi argument je 'y'; opcino se moze dodati
# i vrednosti 'x', ako se ne daju, funkcija
# podrazumeva da je razmak izmedju tacaka 1

# =================================================== #

intpfun = interp1d(a, b)
...
par, cov = curve_fit(fitfun, a, b, sigma=c)
# opciono je davanje gresaka merenja preko argumenta 'sigma'
# izlaz iz fita su 2 promenljive:
...
plt.errorbar(a, b, c, fmt='o', label='posmatranja')
# crtamo najbolji fit kako bismo uporedili sa
plt.plot(
    x,
    fitfun(x, par[0], par[1], par[2]),
    label='najbolji fit')
# posmatranjima
# jednostavniji poziv fitfun je: fitfun(x, *par)
# *par - kada je 'par' niz, python ce raspakovati argumente
plt.xlabel('x')
plt.ylabel('y')
