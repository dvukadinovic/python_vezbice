...
# (da imaju isti broj elemenata i da im je isti raspored (ako su matrice))
...
# bitno! len(a) mora biti jednako len(b) da bi vstack proslo
print(c)
print(c.shape)
...
print(a[0, :])
# printanje svih elemenata iz prvog reda, isto bi islo i samo a[0]
print(a[:, 0])
